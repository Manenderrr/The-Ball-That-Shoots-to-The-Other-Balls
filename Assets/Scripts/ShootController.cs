...
public class ShootController : MonoBehaviour
{
    ...
    public GameObject Shot()
    {
        ...
        Bullet.transform.position = transform.position + Direction.normalized * (GetComponent<CircleCollider2D>().radius + Bullet.GetComponent<CircleCollider2D>().radius + 0.1f);
        ...
        Bullet.GetComponent<Rigidbody2D>().AddForce(Direction.normalized * BulletPower);
